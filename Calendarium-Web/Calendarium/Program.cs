...
BaseCalendar calendarioGregoriano = new BaseCalendar(03, "Gregoriano", 1, "Ejemplos", "https://sitioweb.com/url", 2, true, new DateTime(522, 3, 27), "Icon3.png", 12, 7, 2, 29, 2000, 4, "Domingo", "Lunes", "Martes", "Miercoles", "Jueves",
...
PersonalCalendar primero = new PersonalCalendar(42, "Primero", 4, "Para la tarea", "https://sitioweb.com/url2", true, new DateTime(522, 3, 27), 03, "Dies Solis", "Dies Lunae", "Dies Martis", "Dies Mercurii",
